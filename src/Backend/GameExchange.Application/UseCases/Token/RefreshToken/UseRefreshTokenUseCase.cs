...
using GameExchange.Domain.ValueObjects;
...
namespace GameExchange.Application.UseCases.Token.RefreshToken
{
    public class UseRefreshTokenUseCase : IUseRefreshTokenUseCase
    {
        ...
        public async Task<ResponseTokensJson> Execute(RequestNewTokenJson request)
        {
            ...
            var refreshTokenValidUntil = refreshToken.CreatedOn.AddDays(GameExchangeRuleConstants.REFRESH_TOKEN_EXPIRATION_DAYS);
