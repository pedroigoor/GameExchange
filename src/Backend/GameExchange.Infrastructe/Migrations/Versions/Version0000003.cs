...
namespace GameExchange.Infrastructe.Migrations.Versions
{
    ...
    public class Version0000003 : VersionBase
    {
        public override void Up()
        {
            ...
            CreateTable("Games")
            .WithColumn("Name").AsString().NotNullable()
            .WithColumn("CategoryId").AsInt64().NotNullable().ForeignKey("FK_RefreshTokens_Category_Id", "Platforms", "Id") 
            .WithColumn("PlataformId").AsInt64().NotNullable().ForeignKey("FK_RefreshTokens_Plataform_Id", "Categories", "Id");
        }
    }
}
